...
{
    $sql = "SELECT * FROM hoadon,hoadon_chitiet,khachhang WHERE khachhang.sdt = hoadon.phone and hoadon.id = hoadon_chitiet.id  and khachhang.ten_dang_nhap = ? ORDER BY hoadon.id DESC ";
    return pdo_query($sql, $ten_dang_nhap);
}
