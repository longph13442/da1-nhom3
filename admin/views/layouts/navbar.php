<nav id="sidebarMenu" class="navbar navbar-expand-lg col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 ">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-dark active text-dark" aria-current="page" href="<?= ROOT_URL ?>cpadmin">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark text-dark" href="<?= ROOT_URL ?>order">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="<?= ROOT_URL ?>products">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="<?= ROOT_URL ?>cpadmin/user">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="<?= ROOT_URL ?>statistical">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="<?= ROOT_URL ?>category">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark text-dark" href="<?= ROOT_URL ?>comments">
                    <svg aria-hidden="true" focusable="false" data-prefix="far" width="24" height="24" data-icon="comments" class="svg-inline--fa fa-comments fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark text-dark" href="<?= ROOT_URL ?>slide">
                    <svg aria-hidden="true" focusable="false" data-prefix="far" width="24" height="24" data-icon="image" class="svg-inline--fa fa-image fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
