<footer class="py-5 bg-light px-5">
    <div class="row">
        ...
        <div class="col-3">
            ...
            <ul class="nav flex-column text-center">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark">#hàn quốc</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark">#dưỡng ẩm</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark">#chất lượng</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark">#make-up</a></li>
            </ul>
        </div>
    ...
    <div class=" py-4 my-4 border-top ">
        <p class="text-center">© 2021 Company, Inc. All rights reserved.</p>
    </div>
</footer>