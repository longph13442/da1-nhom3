<div class="col-3">
    <ul class="list-group">
        ...
        <li class="list-group-item p-3"><i class="fas fa-map-marker-alt p-3"></i><a class="text-decoration-none" href="">Địa chỉ</a></li>
        ...
        <?php if (!isset($_SESSION['vai_tro']) != 1) : ?>
            <li class="list-group-item p-3"><i class="fas fa-user p-3"></i><a onclick="javascript:openWindow(this.href);return false;" href="<?= ROOT_URL ?>admin/user" class="text-decoration-none">Quản trị</a></li>
        <?php endif; ?>
