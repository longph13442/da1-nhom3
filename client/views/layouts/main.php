            ...
            <div class="modal-content" style="width: 600px;">
                ...
                <div class="modal-body">
                    <div class="text-center my-4 ">
                        <a href="./homepage.html"> <img class="mb-4" src="<?=homepase_ASSET?>/image/logo.png" alt="" height="70" ></a>
                    ...
                    <form class="form-signin mx-auto" style=" width: 500px;">
                        ...
                        <div class="form-label-group">
                            <label for="inputEmail mb-5">Email hoặc Tên</label>
                            <input type="email" id="inputEmail" class="form-control my-2" placeholder="Nhập email"
                                required="" autofocus="">
                        ...
                        <div class=" row checkbox mb-3 my-4">
                            ...
                            <label class="col-4">
                                <a href="./login/get_password.html" class="text-dark">Quên mật khẩu ?</a>
                            </label>
                            <label class="col-4">
                                <a href="./login/register.html" class="text-dark">Chưa có tài khoản</a>
                            </label>
                        </div>
                        <button class="btn  btn-warning btn-md" type="submit">Đăng nhập</button>
