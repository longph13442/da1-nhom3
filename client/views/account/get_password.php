<form class="form-signin mx-auto my-5" style=" width: 500px;" action="<?= Account . 'forgot' ?>" method="post">
    ...
    <button class="btn btn-md btn-warning btn-block my-3" type="submit">Gửi</button>
