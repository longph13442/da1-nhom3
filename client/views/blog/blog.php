        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden d-flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                ...
                <div class="col-5 d-none d-lg-block">
                    <img src="<?= ADMIN_ASSET ?>Image/1.webp" alt="" width="100%" height="100%">
        ...
        <div class="row g-5">
            ...
            <div class="col-md-3 ">
                <div class="position-sticky" style="top: 2rem;">
                    ...
                    <div class="p-4">
                        <h4 class="fst-italic">Bài viết từ</h4>
                        <ol class="list-unstyled mb-0">
                            <li><a href="#" class="text-warning">March 2021</a></li>
                            <li><a href="#" class="text-warning">February 2021</a></li>
                            <li><a href="#" class="text-warning">January 2021</a></li>
                            <li><a href="#" class="text-warning">December 2020</a></li>
                            <li><a href="#" class="text-warning">November 2020</a></li>
                            <li><a href="#" class="text-warning">October 2020</a></li>
                            <li><a href="#" class="text-warning">September 2020</a></li>
                            <li><a href="#" class="text-warning">August 2020</a></li>
                            <li><a href="#" class="text-warning">July 2020</a></li>
                            <li><a href="#" class="text-warning">June 2020</a></li>
                            <li><a href="#" class="text-warning">May 2020</a></li>
                            <li><a href="#" class="text-warning">April 2020</a></li>
                        </ol>
                    </div>
